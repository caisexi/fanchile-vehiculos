...
<?php $form = $this->beginWidget('GxActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model, 'id_reigistro_factura'); ?>
		<?php echo $form->dropDownList($model, 'id_reigistro_factura', GxHtml::listDataEx(RegistroFactura::model()->findAllAttributes(null, true)), array('prompt' => Yii::t('app', 'All'))); ?>
	</div>
