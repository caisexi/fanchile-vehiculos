...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns' => array(
		...
		array(
				...
				'value'=>'GxHtml::valueEx($data->idAreaEmpresa)',
				'filter'=>GxHtml::listDataEx(AreasEmpresa::model()->findAllAttributes(null, true)),
				),
		array(
                    'class' => 'CButtonColumn',
                    'header' => 'Opciones',
                    ...
                    (
                        ...
                        (
                            'label'=>'Ver',
                            'url'=>'Yii::app()->createUrl("cargosempresa/view", array("id"=>$data->id))',
                            'imageUrl'=>Yii::app()->baseUrl . '/images/ver.png',
                        ),
                        'update' => array
                        (
                            'label'=>'Editar',
                            'url'=>'Yii::app()->createUrl("cargosempresa/update", array("id"=>$data->id))',
                            'imageUrl'=>Yii::app()->baseUrl . '/images/editar.png',
                        ),
                        'delete' => array
                        (
                            'label'=>'Borrar',
                            'url'=>'Yii::app()->createUrl("cargosempresa/delete", array("id"=>$data->id))',
