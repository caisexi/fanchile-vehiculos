...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns' => array(
		...
		array(
				'name'=>'id_ciudad',
				'value'=>'GxHtml::valueEx($data->idCiudad)',
				'filter'=>GxHtml::listDataEx(Ciudades::model()->findAllAttributes(null, true)),
				),
		'nombreContacto',
		/*
		'apellidoContacto',
		...
		*/
		array(
                    ...
                    (
                        ...
                        (
                            'label'=>'Ver',
                            'url'=>'Yii::app()->createUrl("proveedores/view", array("id"=>$data->id))',
                            'imageUrl'=>Yii::app()->baseUrl . '/images/ver.png',
                        ),
                        'update' => array
                        (
                            'label'=>'Editar',
                            'url'=>'Yii::app()->createUrl("proveedores/update", array("id"=>$data->id))',
                            'imageUrl'=>Yii::app()->baseUrl . '/images/editar.png',
                        ),
                        'delete' => array
                        (
                            'label'=>'Borrar',
                            'url'=>'Yii::app()->createUrl("proveedores/delete", array("id"=>$data->id))',
