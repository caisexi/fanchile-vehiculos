...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('colores-vehiculos-grid', {
		data: $(this).serialize()
	});
	return false;
});
	...
	'columns' => array(
		...
		array(
                    ...
                    (
                        ...
                        (
                            'label'=>'Ver',
                            'url'=>'Yii::app()->createUrl("coloresvehiculos/view", array("id"=>$data->id))',
                            'imageUrl'=>Yii::app()->baseUrl . '/images/ver.png',
                        ),
                        'update' => array
                        (
                            'label'=>'Editar',
                            'url'=>'Yii::app()->createUrl("coloresvehiculos/update", array("id"=>$data->id))',
                            'imageUrl'=>Yii::app()->baseUrl . '/images/editar.png',
                        ),
                        'delete' => array
                        (
                            'label'=>'Borrar',
                            'url'=>'Yii::app()->createUrl("coloresvehiculos/delete", array("id"=>$data->id))',
