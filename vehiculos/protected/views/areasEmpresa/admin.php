...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('areas-empresa-grid', {
		data: $(this).serialize()
	});
	return false;
});
	...
	'columns' => array(
		...
		array(
                    ...
                    (
                        ...
                        (
                            'label'=>'Ver',
                            'url'=>'Yii::app()->createUrl("areasempresa/view", array("id"=>$data->id))',
                            'imageUrl'=>Yii::app()->baseUrl . '/images/ver.png',
                        ),
                        'update' => array
                        (
                            'label'=>'Editar',
                            'url'=>'Yii::app()->createUrl("areasempresa/update", array("id"=>$data->id))',
                            'imageUrl'=>Yii::app()->baseUrl . '/images/editar.png',
                        ),
                        'delete' => array
                        (
                            'label'=>'Borrar',
                            'url'=>'Yii::app()->createUrl("areasempresa/delete", array("id"=>$data->id))',
